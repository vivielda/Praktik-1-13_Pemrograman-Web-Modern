    ...
    <div className="form-demo">
      ...
      <form onSubmit={handleSubmit} onReset={handleReset}
        ...
        <div className="form-group">
          ...
          />
          {hasError('nama') && <span className="error-text">
            {errors.nama}</span>}
        </div>
        ...
        <div className="form-group">
          ...
          />
          {hasError('email') && <span className="error-text">
            {errors.email}</span>}
        </div>
        ...
        <div className="form-group">
          ...
          />
          {hasError('password') && <span className="error-text">
        ...
        <div className="form-group">
          ...
          <input
            ...
            max="60"
          />
          {hasError('usia') && <span className="error-text">
            {errors.usia}</span>}
        </div>
        ...
        <div className="form-group">
          ...
          {hasError('gender') && <span className="error-text">
            {errors.gender}</span>}
        </div>
        ...
        <div className="form-group">
          ...
          {hasError('jurusan') && <span className="error-text">
            {errors.jurusan}</span>}
        </div>
        ...
        <div className="form-group checkbox-group">
          <label className="checkbox-label">
            <input
              ...
              onChange={handleChange}
            />
            Saya ingin menerima info newsletter
          </label>
        </div>
